...
export class UsSocketClient extends SocketClient<Connector> {
  constructor() {
    super({ voltage: 110, name: "US-Power-Socket" });
  }
}

export class KrSocketClient extends SocketClient<Connector> {
  constructor() {
    super({ voltage: 220, name: "KR-Power-Socket" });
  }
}
